		...
		public GraphQLSchema.Builder build() {
			try {
				...
				try (ScanResult scanResult = new ClassGraph()
					...
					Set<Class<? extends Authorizer>> authorizers = new HashSet<>(scanResult.getClassesImplementing(Authorizer.class).loadClasses(Authorizer.class));
					...
					Set<Class<? extends SchemaConfiguration>> schemaConfiguration = new HashSet<>(scanResult.getClassesImplementing(SchemaConfiguration.class).loadClasses(SchemaConfiguration.class));
