...
public class OrgEntry extends Table {

	private String name;
	private String globalLookup;

	public OrgEntry(String name, String globalLookup) {
		this.name = name;
	...
	public List<OrgRelated> getRelated(VirtualDatabase db) {
		return db.query(OrgRelated.class);
	}
